...
public class ResultadoDosAnimais {
	...
	public static void main (String[] args) {
		...
		System.out.println("Nome do cavalo:"+	cavalo.getNome()+"				Idade do cavalo:"+cavalo.getIdade()+"				Ação do cavalo:"+ 	cavalo.getAcao());
		System.out.println("Nome do preguica:"+preguica.getNome()+"				Idade do preguica:"+preguica.getIdade()+"			Ação do preguica:"+ preguica.getAcao());
